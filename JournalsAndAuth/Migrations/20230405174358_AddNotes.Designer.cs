...
namespace JournalsAndAuth.Migrations
{
    ...
    [Migration("20230405174358_AddNotes")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JournalsAndAuth.Areas.Identity.Data.JournalsUser", b =>
                {
            ...
            modelBuilder.Entity("JournalsAndAuth.Models.Blog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("JournalsAndAuth.Models.Note", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("JournalsAndAuth.Models.Note", b =>
                {
                    b.HasOne("JournalsAndAuth.Models.Journal", "Journal")
                        .WithMany("Notes")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("JournalsAndAuth.Areas.Identity.Data.JournalsUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
